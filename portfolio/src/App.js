		...
		<main className="max-w-5xl mx-auto p-6 space-y-8">
			...
			<section className="text-center">
				...
				<div className="flex justify-center space-x-4 mt-2">
					<a href="mailto:jbrackin1@gmail.com">
						<Mail className="w-5 h-5" />
					</a>
					<a href="tel:2254214403">
						<Phone className="w-5 h-5" />
					</a>
					<a href="https://www.github.com/jbrackin1">
					...
					<ul className="space-y-4">
						<li>
							<h3 className="text-xl font-medium">
								BeadPay – Crypto Civil Fines System
							</h3>
							<p>
						...
						<li>
							<h3 className="text-xl font-medium">
								Cell Work Bio Education Platform
							</h3>
							<p>
			...
			<Card>
				<CardContent className="p-4">
					...
					<p>
						C#, .NET Core, ASP.NET, React, React Native, Xamarin, MAUI, Python,
						JavaScript, TypeScript, Azure, AWS, Docker, Jenkins, SQL, CI/CD,
						Git, TDD, Agile
					</p>
				</CardContent>
			</Card>
